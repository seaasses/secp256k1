...
inline void jacobian_montgomery_double_point(const JacobianPoint *point, JacobianPoint *result_point)
{

    Uint256 tmp_0, tmp_1;
    
    montgomery_multiplication(&point->y, &point->y, &tmp_1);
    montgomery_multiplication(&point->x, &tmp_1, &result_point->y);
    ...
    montgomery_multiplication(&point->x, &point->x, &result_point->z); // ----------------------
    modular_double(&result_point->z, &result_point->x); // ---------------
    modular_addition(&result_point->z, &result_point->x, &result_point->z); // ---------------
    montgomery_multiplication(&result_point->z, &result_point->z, &result_point->x); // --------------------
    ...
    montgomery_multiplication(&result_point->z, &tmp_1, &result_point->z);
    ...
    montgomery_multiplication(&point->y, &point->z, &result_point->z); 
