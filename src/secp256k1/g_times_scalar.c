...
#pragma unroll
        for (unsigned char i = 0; i < 8; ++i)
        {
            ...
            double_point(&tmp_point, result_point);
            double_point(result_point, &tmp_point);
            double_point(&tmp_point, result_point);
            double_point(result_point, &tmp_point);
            double_point(&tmp_point, result_point);
            ...
            point_addition(result_point, &g_times[window], &tmp_point);

            result_point->x.limbs[0] = (g_times[window].x.limbs[0] & mask_use_g_times_window) | (tmp_point.x.limbs[0] & mask_sum_g_times_window) | (result_point->x.limbs[0] & mask_do_not_sum_g_times_window);
            result_point->y.limbs[0] = (g_times[window].y.limbs[0] & mask_use_g_times_window) | (tmp_point.y.limbs[0] & mask_sum_g_times_window) | (result_point->y.limbs[0] & mask_do_not_sum_g_times_window);
            result_point->x.limbs[1] = (g_times[window].x.limbs[1] & mask_use_g_times_window) | (tmp_point.x.limbs[1] & mask_sum_g_times_window) | (result_point->x.limbs[1] & mask_do_not_sum_g_times_window);
            result_point->y.limbs[1] = (g_times[window].y.limbs[1] & mask_use_g_times_window) | (tmp_point.y.limbs[1] & mask_sum_g_times_window) | (result_point->y.limbs[1] & mask_do_not_sum_g_times_window);
            result_point->x.limbs[2] = (g_times[window].x.limbs[2] & mask_use_g_times_window) | (tmp_point.x.limbs[2] & mask_sum_g_times_window) | (result_point->x.limbs[2] & mask_do_not_sum_g_times_window);
            result_point->y.limbs[2] = (g_times[window].y.limbs[2] & mask_use_g_times_window) | (tmp_point.y.limbs[2] & mask_sum_g_times_window) | (result_point->y.limbs[2] & mask_do_not_sum_g_times_window);
            result_point->x.limbs[3] = (g_times[window].x.limbs[3] & mask_use_g_times_window) | (tmp_point.x.limbs[3] & mask_sum_g_times_window) | (result_point->x.limbs[3] & mask_do_not_sum_g_times_window);
            result_point->y.limbs[3] = (g_times[window].y.limbs[3] & mask_use_g_times_window) | (tmp_point.y.limbs[3] & mask_sum_g_times_window) | (result_point->y.limbs[3] & mask_do_not_sum_g_times_window);
